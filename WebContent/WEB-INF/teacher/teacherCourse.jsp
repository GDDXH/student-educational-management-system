...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"TeacherServlet?method=termList",
	        idField:'id', 
	 		...
	 		toolbar: [
	        	{
	        		...
	        		handler: function(){
	                	...
	                	if(exam == null){
	                    	...
	                    	//动态显示该学期的课程	                    	
	                    	setTimeout(function(){
	        			    	$("#escoreList").datagrid("options").url = "TeacherServlet?method=courseList";
	    ...
	    $("#escoreList").datagrid({ 
	        ...
	        remoteSort: false,
	        frozenColumns: [[  
				{field:'scy_cname',title:'课程',width:120,resizable: false,sortable: true},    
